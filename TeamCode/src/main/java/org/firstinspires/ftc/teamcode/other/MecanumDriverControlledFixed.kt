...
class MecanumDriverControlledFixed(
    val motors: Array<out Controllable>,
    ...
    ) : this(motors, driveJoystick, turnJoystick, true, null)
     ...
     * @param gamepad: The gamepad to use the joysticks from
     */
    constructor(motors: Array<out Controllable>, gamepad: GamepadEx) : this(
        motors,
        gamepad.leftStick,
        gamepad.rightStick,
        true,
